...
<body class="bg-gradient-to-br from-[#1e1e2f] to-[#2a2a40] scroll-smooth text-white">
  ...
  <section id="features" class="py-20 px-6 max-w-6xl mx-auto">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-[#1f1f2e] border border-indigo-500/30 p-6 rounded-xl shadow hover:shadow-xl transition">
        <h3 class="text-xl font-semibold text-indigo-400 mb-2">🧠 Group Study rooms</h3>
        <p>Group study is a collaborative learning method where students come and Join live study sessions and collaborate in real-time.</p>
      </div>
      <div class="bg-[#1f1f2e] border border-indigo-500/30 p-6 rounded-xl shadow hover:shadow-xl transition">
        <h3 class="text-xl font-semibold text-indigo-400 mb-2">💬 Discussion Areas</h3>
        <p> Ask questions, share ideas, and solve problems together.</p>
      </div>
    </div>
  </section>
